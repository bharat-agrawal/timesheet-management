...
export default function UpdateProject(props) {
    const {callUpdateProjectApi, object} = props;
    console.log(object)
    ...
    const onSubmit = () => {
        callUpdateProjectApi(formData,setError);
    };
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className={classes.form}>
                        <div className="modal-container">
                            <div className="modal-header">
                                <Typography component="h2" variant="h6" id="transition-modal-title">Update Project</Typography>
