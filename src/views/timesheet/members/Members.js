...
const [value, setValue] = React.useState(0);
    ...
    function callUserDataApi(){
        ...
        fetch(`http://192.168.0.171:8345/user?perPage=${pageDetails.perPage}&page=${pageDetails.page}&q=${pageDetails.query}&sortBy=${orderBy}&sortOrder=${order}`)
  ...
  "username": "string"
            ...
            fetch('http://192.168.0.171:8345/user', {
            method: 'POST',
            headers: {
