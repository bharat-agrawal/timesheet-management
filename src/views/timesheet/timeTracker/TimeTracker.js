...
export default function Projects() {
  ...
  return (
    <div className={classes.root}>
      ...
      <Paper
        className={clsx(classes.paper, classes.boxShadow, classes.spaceTop)+" spaceAllBox"}
        elevation={0}
      >
        <Grid container justify="space-between" alignItems="center">
          <Grid item xs={6} sm={6} md={4} className="spaceAllCol">
            <TextField className="width_100" label="Describe your work" />
          </Grid>
          <Grid item xs={6} sm={6} md={2} className="spaceAllCol width_100">
          <Autocomplete
            id="combo-box-demo"
            className="width_100"
            options={top100Films}
...
<Grid item xs={6} sm={6} md={2} className="spaceAllCol">
<InputLabel id="demo-simple-select-filled-label">Billing</InputLabel>
          <Select
...
<Grid item xs={6} sm={6} md={4} className="spaceAllCol">
      ...
      <Paper
        className={clsx(classes.paper, classes.boxShadow, classes.spaceTop)}
        elevation={0}
      >
        <Grid container justify="space-between" alignItems="center">
